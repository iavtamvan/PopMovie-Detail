...
public class ListMovieModel implements Parcelable {
    ...
    public static final Creator<ListMovieModel> CREATOR = new Creator<ListMovieModel>() {
        @Override
        public ListMovieModel createFromParcel(Parcel in) {
            return new ListMovieModel(in);
        }
